	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'highnote' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'highnote' ); ?></th>
			</tr>
		</thead>
		<tbody>

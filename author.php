		...
		<div class="row">
			...
			<main class="site-main" id="main">
				...
				<header class="page-header author-header">
					...
					<h1><?php echo esc_html__( 'About:', 'highnote' ) . ' ' . esc_html( $curauth->nickname ); ?></h1>
					...
					<?php if ( ! empty( $curauth->user_url ) || ! empty( $curauth->user_description ) ) : ?>
						<dl>
							<?php if ( ! empty( $curauth->user_url ) ) : ?>
								<dt><?php esc_html_e( 'Website', 'highnote' ); ?></dt>
								<dd>
							...
							<?php if ( ! empty( $curauth->user_description ) ) : ?>
								<dt><?php esc_html_e( 'Profile', 'highnote' ); ?></dt>
						...
						while ( have_posts() ) :
							...
							<li>
								...
								printf(
									...
									esc_attr( __( 'Permanent Link:', 'highnote' ) ),
									the_title( '', '', false )
								);
								?>
								<?php highnote_posted_on(); ?>
								<?php esc_html_e( 'in', 'highnote' ); ?>
								<?php the_category( '&' ); ?>
							</li>
						<?php endwhile; ?>

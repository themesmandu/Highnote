...
<section id="wizards_slider">
	<div class="slide-img-wrap">
		...
		<?php foreach ( $active_sliders as $active_slider ) : ?>
			<li>
				<img src="<?php echo esc_url( wp_get_attachment_url( $active_slider['slider_img'] ) ); ?>" alt="<?php echo esc_url( wp_get_attachment_url( $active_slider['slider_img'] ) ); ?>" title="<?php echo esc_html( $active_slider['slider_heading'] ); ?>" />

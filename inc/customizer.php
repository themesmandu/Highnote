	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => 'highnote_customize_partial_blogdescription',
			)
		);
	}
}
 ...
 * @return void
 */
function highnote_customize_partial_blogdescription() {
...
function highnote_customize_preview_js() {
	wp_enqueue_script( 'highnote-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), _S_VERSION, true );
}

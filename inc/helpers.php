...
function highnote_add_menu_item($items, $args)
{
	if (class_exists('Easy_Digital_Downloads')) {
		if ('primary' === $args->theme_location) {
			...
			$widget = ob_get_clean();
			$items .= '<li class="menu-item beats_cart nav-cart">
		<button class="btn-cart btn-beats">
			<i class="fas fa-shopping-cart"></i>
			<span class="cart-count edd-cart-quantity">' . edd_get_cart_quantity() . '</span> Beats</button>

		<div class="cart_content">
			<div class="cart-wrap"><button class="btn btn-close"><span class="screen-reader-text">Close</span></button>' . $widget . '</div>
		</div>
	</li>';
		}
	}

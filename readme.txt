...
Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/HIGHNOTE.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/HIGHNOTE)

## About

I’m a huge fan of Underscores, Bootstrap, and Sass. Why not combine these into a solid WordPress Theme Framework?
That’s what highnote is. 
You can use it as starter theme and build your own theme on top of it. Or you use it as parent theme and create your own child theme for highnote.

At the moment, highnote is in a very early stage. But if you want, feel free to use it for your own WordPress theme!

# highnote WordPress Theme Framework

Website: [https://HIGHNOTE.com](https://HIGHNOTE.com)

Child Theme Project: [https://github.com/holger1411/highnote-child](https://github.com/holger1411/highnote-child)

## License
HIGHNOTE WordPress Theme, Copyright 2013-2017 Holger Koenemann
HIGHNOTE is distributed under the terms of the GNU GPL version 2
...
- Jetpack ready.
- WooCommerce support.
- [Child Theme](https://github.com/holger1411/highnote-child) ready.
- Translation ready.
...
Some basics about the Sass and CSS files that come with highnote:
...
- The `/css/theme.css` and it´s minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 1 "theme/theme_variables";  // <--------- Add your variables into this file. Also add variables to overwrite Bootstrap or highnote variables here
                  - 2 "../src/bootstrap-sass/assets/stylesheets/bootstrap";  // <--------- All the Bootstrap stuff - Don´t edit this!
                  - 3 "HIGHNOTE/HIGHNOTE"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
- Download the highnote folder from GitHub or from highnote.com
- IMPORTANT: If you download it from GitHub make sure you rename the "highnote-master.zip" file just to "HIGHNOTE.zip" or you might have problems using child themes !!
- Upload it into your WordPress installation subfolder here: `/wp-content/themes/`
- Login to your WordPress backend
- Go to Appearance → Themes
- Activate the highnote theme

## Developing With npm, Gulp and SASS and [Browser Sync][1]

### Installing Dependencies
- Make sure you have installed Node.js and Browser-Sync* (* optional, if you wanna use it) on your computer globally
- Then open your terminal and browse to the location of your highnote copy
